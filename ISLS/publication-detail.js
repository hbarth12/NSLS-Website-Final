  ...
  function renderPdf(item, items) {
    ...
    output.innerHTML =
      '<nav class="publication-breadcrumb" aria-label="Breadcrumb">' +
        '<a href="index.html">Home</a><span>/</span><a href="publications.html">Publications</a><span>/</span><a href="publications.html#policy-paper">Policy Papers</a>' +
      '</nav>' +
      '<section class="policy-paper-hero">' +
        '<div class="policy-paper-copy">' +
          ...
          '<div class="policy-paper-actions policy-paper-actions-final">' +
            (download ? '<a class="button primary policy-paper-download policy-paper-action-tile" href="' + escapeHtml(download) + '" target="_blank" rel="noopener">Download PDF</a>' : '') +
            '<div class="policy-paper-stat policy-paper-action-tile"><span>Read time</span><strong>' + escapeHtml(readTime || 'Report') + '</strong></div>' +
            '<div class="policy-paper-stat policy-paper-action-tile"><span>File size</span><strong>' + escapeHtml(fileSize || 'PDF') + '</strong></div>' +
          '</div>' +
        '</div>' +
